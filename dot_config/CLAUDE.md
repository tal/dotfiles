...
The following paths under `~/.config/` are tracked by chezmoi: `bin/`, `Brewfile`, `CLAUDE.md`, `cmux/`, `coding-agents/`, `ghostty/`, `karabiner/`, `leader-key/`, `lsd/`, `ripgrep/`, `starship.toml`, `tuna/`, `zed/`, `zsh/`.
